...
export const meta = () => {
    return [{ title: "Partner Sign Up - Gogo" }];
};
    ...
    <main className="grid grid-cols-4 min-h-screen">
        ...
        <div className="col-span-3 flex justify-center items-center">
            <div className="container w-[600px]">
                <p className="text-brand-primary text-2xl font-bold">Gogo Partner</p>
                <p className="text-brand-primary">0% commissions for up to 30 days</p>
                <Form method="POST" className="space-y-4 flex flex-col mt-4 mb-4">
                ...
                <p className="text-brand-primary">Don't have an account? <Link to="/partner/login" className="hover:text-brand-secondary">Sign In</Link></p>
            </div>
        </div>
    </main>
  )
