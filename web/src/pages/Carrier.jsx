...
export default function Customer() {
    const menuList = [
        {title: "Home", icon: <RxHome size={20}/>, route: "/carrier"},
        // {title: "Cart", icon: <RiShoppingCart2Line size={20}/>, route: "/customer/cart"},
        ...
        {title: "Settings", icon: <RxPerson size={20}/>, route: "/carrier/settings"},
